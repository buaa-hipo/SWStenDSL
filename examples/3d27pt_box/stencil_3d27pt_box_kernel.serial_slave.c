					...
					for (j_inner = 0; j_inner < 8; j_inner++) {
						for (k_inner = 0; k_inner < 64; k_inner++) {
							...
							cacheWrite[base_i][base_j][base_k] = \
								// panel 0
								0.1*cacheRead[base_i-1][base_j-1][base_k-1] + 0.2*cacheRead[base_i-1][base_j-1][base_k] + 0.3*cacheRead[base_i-1][base_j-1][base_k+1]
								+ 0.4*cacheRead[base_i-1][base_j][base_k-1] + 0.5*cacheRead[base_i-1][base_j][base_k] + 0.6*cacheRead[base_i-1][base_j][base_k+1]
								+ 0.7*cacheRead[base_i-1][base_j+1][base_k-1] + 0.8*cacheRead[base_i-1][base_j+1][base_k] + 0.9*cacheRead[base_i-1][base_j+1][base_k+1]
								
								// panel 1
								+ 0.1*cacheRead[base_i][base_j-1][base_k-1] + 0.2*cacheRead[base_i][base_j-1][base_k] + 0.3*cacheRead[base_i][base_j-1][base_k+1]
								+ 0.4*cacheRead[base_i][base_j][base_k-1] + 0.5*cacheRead[base_i][base_j][base_k] + 0.6*cacheRead[base_i][base_j][base_k+1]
								+ 0.7*cacheRead[base_i][base_j+1][base_k-1] + 0.8*cacheRead[base_i][base_j+1][base_k] + 0.9*cacheRead[base_i][base_j+1][base_k+1]
