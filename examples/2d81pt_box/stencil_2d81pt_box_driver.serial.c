...
void mpe_verify()
{
    ...
    for (iter = 0; iter < ITERATION/2; iter++) {
        ...
        for (i = HALO; i < M-HALO; i++) {
            for (j = HALO; j < N-HALO; j++) {
                input_mpe[i][j] = \
                    0.1*tmp_mpe[i-4][j-4] + 0.2*tmp_mpe[i-4][j-3] + 0.3*tmp_mpe[i-4][j-2] + 0.4*tmp_mpe[i-4][j-1] + 0.5*tmp_mpe[i-4][j] + 0.6*tmp_mpe[i-4][j+1] + 0.7*tmp_mpe[i-4][j+2] + 0.8*tmp_mpe[i-4][j+3] + 0.9*tmp_mpe[i-4][j+4] +
                    0.1*tmp_mpe[i-3][j-4] + 0.2*tmp_mpe[i-3][j-3] + 0.3*tmp_mpe[i-3][j-2] + 0.4*tmp_mpe[i-3][j-1] + 0.5*tmp_mpe[i-3][j] + 0.6*tmp_mpe[i-3][j+1] + 0.7*tmp_mpe[i-3][j+2] + 0.8*tmp_mpe[i-3][j+3] + 0.9*tmp_mpe[i-3][j+4] +
                    0.1*tmp_mpe[i-2][j-4] + 0.2*tmp_mpe[i-2][j-3] + 0.3*tmp_mpe[i-2][j-2] + 0.4*tmp_mpe[i-2][j-1] + 0.5*tmp_mpe[i-2][j] + 0.6*tmp_mpe[i-2][j+1] + 0.7*tmp_mpe[i-2][j+2] + 0.8*tmp_mpe[i-2][j+3] + 0.9*tmp_mpe[i-2][j+4] +
                    0.1*tmp_mpe[i-1][j-4] + 0.2*tmp_mpe[i-1][j-3] + 0.3*tmp_mpe[i-1][j-2] + 0.4*tmp_mpe[i-1][j-1] + 0.5*tmp_mpe[i-1][j] + 0.6*tmp_mpe[i-1][j+1] + 0.7*tmp_mpe[i-1][j+2] + 0.8*tmp_mpe[i-1][j+3] + 0.9*tmp_mpe[i-1][j+4] +
                    0.1*tmp_mpe[i][j-4] + 0.2*tmp_mpe[i][j-3] + 0.3*tmp_mpe[i][j-2] + 0.4*tmp_mpe[i][j-1] + 0.5*tmp_mpe[i][j] + 0.6*tmp_mpe[i][j+1] + 0.7*tmp_mpe[i][j+2] + 0.8*tmp_mpe[i][j+3] + 0.9*tmp_mpe[i][j+4] +
                    0.1*tmp_mpe[i+1][j-4] + 0.2*tmp_mpe[i+1][j-3] + 0.3*tmp_mpe[i+1][j-2] + 0.4*tmp_mpe[i+1][j-1] + 0.5*tmp_mpe[i+1][j] + 0.6*tmp_mpe[i+1][j+1] + 0.7*tmp_mpe[i+1][j+2] + 0.8*tmp_mpe[i+1][j+3] + 0.9*tmp_mpe[i+1][j+4] +
                    0.1*tmp_mpe[i+2][j-4] + 0.2*tmp_mpe[i+2][j-3] + 0.3*tmp_mpe[i+2][j-2] + 0.4*tmp_mpe[i+2][j-1] + 0.5*tmp_mpe[i+2][j] + 0.6*tmp_mpe[i+2][j+1] + 0.7*tmp_mpe[i+2][j+2] + 0.8*tmp_mpe[i+2][j+3] + 0.9*tmp_mpe[i+2][j+4] +
                    0.1*tmp_mpe[i+3][j-4] + 0.2*tmp_mpe[i+3][j-3] + 0.3*tmp_mpe[i+3][j-2] + 0.4*tmp_mpe[i+3][j-1] + 0.5*tmp_mpe[i+3][j] + 0.6*tmp_mpe[i+3][j+1] + 0.7*tmp_mpe[i+3][j+2] + 0.8*tmp_mpe[i+3][j+3] + 0.9*tmp_mpe[i+3][j+4] +
                    0.1*tmp_mpe[i+4][j-4] + 0.2*tmp_mpe[i+4][j-3] + 0.3*tmp_mpe[i+4][j-2] + 0.4*tmp_mpe[i+4][j-1] + 0.5*tmp_mpe[i+4][j] + 0.6*tmp_mpe[i+4][j+1] + 0.7*tmp_mpe[i+4][j+2] + 0.8*tmp_mpe[i+4][j+3] + 0.9*tmp_mpe[i+4][j+4];
