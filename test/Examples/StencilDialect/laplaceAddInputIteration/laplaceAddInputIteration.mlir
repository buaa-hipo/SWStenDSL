...
module {
    ...
    func @laplaceAddInput_iteration(%in: !stencil.field<72x18x16xf64>, %out: !stencil.field<72x18x16xf64>) attributes { stencil.iteration }
    {
        stencil.iteration @laplaceAddInput((%in: !stencil.field<72x18x16xf64>, %out: !stencil.field<72x18x16xf64>),
